...
source ("../prep-data.R")
ethnicities <- c("Caucasian", "Asian", "International", "Latino", "Two or more races", "Black/African", "Prefer not to answer", "Hawaiian/Pacific Islander", "American Indian/Alaska Native")
